...
#include "Entity.h"
#include "Colliders.h"
Bullet::Bullet(Vector2 position, int damage, Vector2 initalVelocity, Entity* src, bool hostile, bool friendly) : Arrow(position, damage, initalVelocity, src, 0.1, 1, "assets\\projectiles\\bullet.png") {
